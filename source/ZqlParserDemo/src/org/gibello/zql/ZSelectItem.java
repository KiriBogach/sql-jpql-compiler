...
public class ZSelectItem extends ZAliasedName {
	 ...
	 * 
	 * @param fullname A string that represents a column name or wildcard (example:
	 *                 a.*).
	 */
	 ...
	 * 
	 * @return The name of an aggregate function (generally SUM, AVG, MAX, MIN), or
	 *         null if there's no aggregate. Example: SELECT name, AVG(age) FROM
	 *         people; -> null for the "name" item, and "AVG" for the "AVG(age)"
	 *         item.
	 */
	...
	/**
	 * @return An SQL Expression if this SELECT item is an expression, a ZConstant
	 *         if it is a column name, null if it is a wildcard
	 */
	...
	/**
	 * Initialize an aggregate function on this item (generally SUM, AVG, MAX, MIN)
	 * Example: SELECT AVG(age) FROM people; -> The aggregate function is AVG.
	 * 
	 * @param a The name of the aggregate function (a String, like SUM, AVG, MAX,
	 *          MIN)
	 */
	...
	/**
	 * TBD public String toString() { String agg = getAggregate(); if(agg == null)
	 * agg = ""; return agg + super.toString(); }
	 **/
};
