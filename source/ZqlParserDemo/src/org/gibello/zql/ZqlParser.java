...
public class ZqlParser {
	 ...
	 * If the program receives one argument, it is an SQL text file name; if there's
	 * no argument, the program reads from stdin.
	 */
	...
	/**
	 * Create a new parser: before use, call initParser(InputStream) to specify an
	 * input stream for the parsing.
	 */
	public ZqlParser() {
	}
