...
public class Recorrer {
	...
	public static void analyzeSelectStmt(TSelectSqlStatement pStmt) {
		System.out.println("\nSelect statement:");
	...
	public static void main(String args[]) {
		...
		sqlparser.sqltext = ""
				+ " SELECT (SELECT test FROM Other a) as subquery, e.last_name AS name, e.commission_pct comm, e.salary * 12 \"Annual Salary\""
				+ " FROM scott.employees AS e" + " LEFT JOIN movidas ON movidas.id = e.id" 
				+ " WHERE e.salary > 1000 AND movidas.nombre = \"movidote\""
